...
class SettingsTheme extends StatelessWidget {
  ...
  void _change({ThemeMode? mode , ChatStyle? chatStyle , required ThemeCubit cubit}){
    cubit.edit(cubit.value.copyWith(
      mode: mode,
      chatTheme: chatStyle
    ))
  ;
            ...
            child: Column(
              ...
              children: [
                SettingsThemeCustomizeChatColors(
                  onChanged: (style) => _change(chatStyle: style, cubit: themeCubit),
                  selectedChatStyle: themeCubit.value.chatTheme,
                ),
